  ...
  <div class="card-body">
		...
		<table class="table table-custom">
			<tbody>
				...
				<tr>
					<td>{{$product->name}}</td>
					<td><p class="float-right">{{Store::convertAndFormat($product->price)}} {{\Store::getCurrentCurencyString()}}<a href="#" data-toggle="modal" data-target="#Product{{$product->id}}" class="btn btn-dark">Buy</a></p></td>
				</tr>
				@endforeach
			</tbody>
		</table>
